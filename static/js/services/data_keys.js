...
export const DATA_KEYS = {
    ...
    /**
     * Repository dei modelli LLM accettati (procedura di aggiornamento LLM)
     * Struttura: { "<provider>": ["<model>", ...], ... }
     */
    KEY_LLM_REPOSITORY: "llm_repository",
...
const KEY_DESCRIPTIONS = {
    ...
    [DATA_KEYS.KEY_LLM_REPOSITORY]: "Repository Modelli LLM Accettati",
